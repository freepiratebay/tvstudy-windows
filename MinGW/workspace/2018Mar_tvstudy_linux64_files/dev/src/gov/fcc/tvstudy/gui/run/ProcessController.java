...
//  TVStudy
//
//  Copyright (c) 2014-2017 Hammett & Edison, Inc.  All rights reserved.
...
public interface ProcessController {
	...
	//-----------------------------------------------------------------------------------------------------------------
	// Called by process panel UI when the cancel/abort button is pressed, this must entirely handle the action.

	public boolean stopProcess(ProcessPanel theProcess);
}
