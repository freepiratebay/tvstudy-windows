...
public class ExtDbRecordFM extends ExtDbRecord implements Record {
	...
	public static int addRecords(ExtDb extDb, ScenarioEditData scenario, int searchType, String query,
			...
			boolean preferOperating, boolean setUndesired, ErrorLogger errors) {
	...
	// DTV rule-making records that have a facility ID that does not match the actual station.

	public static boolean areRecordsMX(ExtDbRecordFM a, ExtDbRecordFM b, double mxDist, double kmPerDeg) {
		return areRecordsMX(
	...
	public static boolean areRecordsMX(ExtDbRecordFM a, SourceEditDataFM b, double mxDist, double kmPerDeg) {
		return areRecordsMX(
			a.facilityID, a.channel, a.country.key, a.state, a.city, a.location,
			b.facilityID, b.channel, b.country.key, b.state, b.city, b.location,
			mxDist, kmPerDeg);
	...
	public static boolean areRecordsMX(SourceEditDataFM a, SourceEditDataFM b, double mxDist, double kmPerDeg) {
		return areRecordsMX(
			a.facilityID, a.channel, a.country.key, a.state, a.city, a.location,
			b.facilityID, b.channel, b.country.key, b.state, b.city, b.location,
			mxDist, kmPerDeg);
	...
	private static boolean areRecordsMX(int a_facilityID, int a_channel, int a_country_key, String a_state,
			...
			String b_city, GeoPoint b_location, double mxDist, double kmPerDeg) {
