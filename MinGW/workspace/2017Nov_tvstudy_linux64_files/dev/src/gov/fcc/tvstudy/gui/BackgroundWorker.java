...
public abstract class BackgroundWorker<ReturnType> extends SwingWorker<ReturnType, String> implements StatusReporter {
	...
	// the dialog will remain visible for a minimum amount of time.  The object returned from doBackgroundQuery() is
