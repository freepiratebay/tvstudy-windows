...
// reference facility location are irrelevant for this test.  For LPTV and Class A, the coordination test for Canada
// is a contour check, project a particular F(50,10) contour and test if it crosses the Canadian border.
